          ...
          <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
            ...
            <div className="bg-gray-200 p-6 rounded-lg">
              ...
              <div className="space-y-4 max-lg:mt-4">
                ...
                <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-slate-900 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">Graphic design</button>
                <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-slate-900 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Design system</button>
              </div>
              ...
              <form className="mt-8 space-y-4">
                ...
                <textarea placeholder='Message' rows={6}
                  className="w-full rounded-lg px-4 text-slate-900 text-sm pt-3 outline-none"></textarea>
                <button type='button'
                  className="text-white bg-[#a91079] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm font-medium px-4 py-3 flex items-center justify-center w-full !mt-6">
