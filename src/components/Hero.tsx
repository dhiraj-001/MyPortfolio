  ...
  return (
    <HeroHighlight>
      <motion.h1
        ...
        className="items-center px-4 grid w-screen gap-20 grid-cols-1 mdl:grid-cols-2 flex-wrap md:text-4xl lg:text-5xl font-bold text-neutral-700 dark:text-white leading-relaxed lg:leading-snug text-center mx-auto"
      >
