...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-72 w-[28rem] relative shrink-0 cursor-pointer"
    >
      <a
        href={product.link}
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-body">
        {product.title}
      </h2>
    </motion.div>
  );
